  ...
  return (
    <div id="about" className="bg-white px-4 py-8 md:py-12">
      ...
      <div className="flex flex-col md:flex-row-reverse md:justify-center items-center">
        ...
        <p className="text-left" style={{ maxWidth: '40rem' }}>
          Lorem ipsum dolor sit amet. Aut perferendis rerum ea accusamus modi id consequatur alias vel omnis architecto
          et velit eius. Rem quae aliquid eum magnam dolorem id reiciendis necessitatibus vel eius obcaecati...
        </p>
      </div>
    </div>
  );
