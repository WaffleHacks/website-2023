...
const FaqFrame = () => {
  const faqs = [
    [
      'What is a hackathon?',
      <span className="faq-desc-text" style={{ color: 'rgb(255, 219, 184)' }}>
    ...
    [
      ...
      <span className="faq-desc-text" style={{ color: 'rgb(255, 219, 184)', fontSize: 'min(2vw, 1.6rem)' }}>
    ...
    <div id="faqs" className="bg-white p-8 md:text-left flex justify-center">
      <div className="block w-full" style={{ maxWidth: 'min(100vw, 80rem)' }}>
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          {faqs.map((faq, ind) => (
            <div className="p-4 border-2 border-[#2258A1] rounded-lg">
